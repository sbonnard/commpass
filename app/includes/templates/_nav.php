        ...
        <li class="nav__itm ' . $NetworkActive . ' dropdown">
            ...
            <ul class="dropdown__child" id="dropdown-child">
                <li class="dropdown__child-itm">
                    <a href="/clients" class="dropdown__child-lnk" aria-label="Lien vers mes clients">Mes clients</a>
                </li>
                <li class="dropdown__child-itm">
                    <a href="/partners" class="dropdown__child-lnk" aria-label="Lien vers mes partenaires">Mes partenaires</a>
                </li>
                <li class="dropdown__child-itm">
