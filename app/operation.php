...
<body>
    ...
    <main class="container container--campaigns container__flex">
        ...
        <div class="card">
            ...
            <form class="form hidden" action="api.php" method="post" id="new-media-form" aria-label="Création d'un nouveau média si absent de la liste précédente.">
                <ul class="form__lst">
            ...
            <form class="form hidden" action="api.php" method="post" id="new-partner-form" aria-label="Création d'un nouveau partenaire si absent de la liste précédente.">
                <ul class="form__lst">
                    <li class="form__itm form__itm--small">
